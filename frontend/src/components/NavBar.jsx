...
const NavBar = ({ activePage }) => {
  ...
  const navLinks = [
    ...
    { name: 'Manage Bookings', path: '/manage-bookings', id: 'manage-bookings' },
    { name: 'Manage Rooms', path: '/manage-rooms', id: 'manage-rooms' },
    { name: 'Analytics', path: '/analytics', id: 'analytics' },
  ];

  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'shadow-md bg-plek-dark' : 'bg-plek-dark bg-opacity-95'}`}>
